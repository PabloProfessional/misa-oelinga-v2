...
<template>
    <section >
        <header>
            <h2 class="text-lg font-medium text-gray-900">Activity financials <small><span class="text-gray-700">| Budget and spend</span></small></h2>

            <p class="mt-1 text-sm text-gray-600">
                Total budget and spend for this activity in the current Financial Year
            </p>
