...
<template>
    <section >
        <header>
            <h2 class="text-lg font-medium text-gray-900">Planned  Duration<small><span class="text-gray-700"> | or activity timeline</span></small></h2>

            <p class="mt-1 text-sm text-gray-600">
                Start and end dates of the activity with stage the project is currently in.
            </p>
